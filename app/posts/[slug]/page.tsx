  ...
  return (
    <div className=" min-h-screen">
      <div className="container mx-auto px-5 py-8">
        {/* Header */}
        <h2 className="mb-10 mt-4 text-3xl font-bold  hover:text-indigo-600 transition-colors">
        ...
        <article>
          ...
          <div className="mx-auto max-w-2xl ">
            <div className=" lg:prose-xl prose-a:text-indigo-600 prose-a:no-underline hover:prose-a:underline">
