      ...
      <div className="flex items-center justify-between">
        ...
        <div className="max-w-md text-zinc-500">
          <p className="text-sm">
            ...
            with occasional ventures into Web design and React Native. Projects that
            emphasize clean architecture, fast performance with security focused , and interfaces people
